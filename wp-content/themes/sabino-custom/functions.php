...
function sabino_scripts() {
	...
	wp_enqueue_style( 'sabino-font-awesome', get_template_directory_uri().'/includes/font-awesome/css/all.min.css', array(), '5.5.0' );
...
function sabino_register_required_plugins() {
	$plugins = array(
		...
		array(
			'name'      => __( 'Contact Form by WPForms', 'sabino' ),
			'slug'      => 'wpforms-lite',
			'required'  => false,
		),
		array(
